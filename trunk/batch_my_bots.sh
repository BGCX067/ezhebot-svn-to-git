#!/bin/bash
    ...
    do
       ...
       for i in {1..100}
       do
          RES=`java -jar tools/PlayGame.jar maps/map$i.txt 1000 200 log.txt "python2.5 $file" "python2.5 MyBot.py" 2>&1 | tail -n 3 | grep "Turn\|Player"`
